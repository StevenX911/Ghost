...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = '\n    ' + _icons.heart + '\n    ' + (likedReaction ? '不喜欢' : '喜欢') + '\n    ' + (meta.reactions && meta.reactions.heart ? ' \u2022 <strong>' + meta.reactions.heart + '</strong> \u559C\u6B22' : '') + '\n  ';
...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    emptyBlock.innerText = '还没有评论，来抢沙发';
  ...
  comments.forEach(function (comment) {
    ...
    commentItem.innerHTML = '\n      <a class="gitment-comment-avatar" href="' + comment.user.html_url + '" rel="nofollow" target="_blank">\n        <img class="gitment-comment-avatar-img" src="' + comment.user.avatar_url + '"/>\n      </a>\n      <div class="gitment-comment-main">\n        <div class="gitment-comment-header">\n          <a class="gitment-comment-name" href="' + comment.user.html_url + '" rel="nofollow" target="_blank">\n            ' + comment.user.login + '\n          </a>\n          \u53D1\u8868\u4E8E\n          <span title="' + createDate + '">' + createDate.toDateString() + '</span>\n          ' + (createDate.toString() !== updateDate.toString() ? ' \u2022 <span title="comment was edited at ' + updateDate + '">\u5DF2\u91CD\u65B0\u7F16\u8F91</span>' : '') + '\n          <div class="gitment-comment-like-btn">' + _icons.heart + ' ' + (comment.reactions.heart || '') + '</div>\n        </div>\n        <div class="gitment-comment-body gitment-markdown">' + comment.body_html + '</div>\n      </div>\n    ';
...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      _utils.http.post('https://admin.tripfe.cn', {
        code: code,
        client_id: client_id,
